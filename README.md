...
Quelle der Wahrheit für diesen Stand: `main` @ `368568e` (PR #9 merge `c0392f0`). Human-verified A Follow, B audio VIS + silence gate, C Loop-off (local exe `0df5da1`). Kein Force-Push auf `main`. AUTO und Icons unangetastet. VIS Ausbau: **geplant / noch kein Code** (Human chose docs-only).
...
Basis: `main` @ `368568e` (PR #9 merge `c0392f0`, exe `0df5da1`), Version 5.0.0.
