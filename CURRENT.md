...
| Branch | `cursor/transport-follow-audio-loop-44f8` (PR #8) auf PR-#7-Tip `cursor/track-header-compact-ms-9690` @ `f75b3b5` |
| Base | PR #7 compact-headers (`f75b3b5`) inkl. VIS seek/cut. Darunter PR #6 Help/S-track, PR #5 WAV/Help-Chrome. |
...
| Visualizer | Canvas-Modi unverändert. Geladenes A1/Mix-PCM treibt Onset/Energy (Visualz-Step). Kein 120-BPM-Fallback solange Audio da ist. |
